...
public class Venta {
     ...
     * 
     * @param elecVendido electrodomestico que queremos actualizar
     */
     ...
     * 
     * @param elecEntregado electrodomestico que queremos actualizar
     */
    ...
    public static String resumenVentas(String texto) {
        ...
        resumen = "RESUMEN DE VENTAS\n";
        for (Venta v : ventas) {
            if (!v.getElecVendido().getMarca().contains(texto))
                continue;
            resumen += v.getTicketLastln() + "\n";
        }
